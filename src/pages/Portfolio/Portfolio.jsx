  ...
  return (
    <div className={`${styles.page} ${lightMode ? styles.lightMode : ''}`}>
        ...
        <div className={styles.aboutInner}>
          ...
          <div className={styles.aboutRight}>
            <div className={styles.aboutCard}>
              ...
              {/* Social links */}
              {brand.brandSocials && brand.brandSocials.length > 0 && (
                <div className={styles.aboutSocials}>
                  {brand.brandSocials.map((s, i) => (
                    <a key={i} href={s.url} target="_blank" rel="noopener noreferrer" className={styles.socialIcon} aria-label={s.platform}>
      ...
      <footer className={styles.footer}>
        ...
        <div className={styles.footerTop}>
          ...
          {brand.brandSocials && brand.brandSocials.length > 0 && (
            <div className={styles.footerSocials}>
              {brand.brandSocials.map((s, i) => (
                <a key={i} href={s.url} target="_blank" rel="noopener noreferrer" className={styles.footerSocialIcon} aria-label={s.platform}>
                  <SocialIcon platform={s.platform} />
                </a>
              ))}
            </div>
        ...
        {/* Bottom: WhatsApp shortcut + powered by */}
